...
public class FinalProject_Manalili extends JFrame {
	...
	private void initialize() {
		...
		btnOpenFile.setIcon(new ImageIcon(Objects.requireNonNull(FinalProject_Manalili.class.getResource("/UsedPicture/icons8-open-folder-16.png"))));
		...
		btnLexical.setIcon(new ImageIcon(Objects.requireNonNull(FinalProject_Manalili.class.getResource("/UsedPicture/icons8-right-arrow-16.png"))));
		btnLexical.setEnabled(false);
		btnLexical.setFocusPainted(false);
		btnLexical.addActionListener(e -> LexicalAnalysis());
		...
		btnSyntax.setIcon(new ImageIcon(Objects.requireNonNull(FinalProject_Manalili.class.getResource("/UsedPicture/icons8-right-arrow-16.png"))));
		btnSyntax.setEnabled(false);
		btnSyntax.setFocusPainted(false);
		btnSyntax.addActionListener(e -> SyntaxAnalysis(out));
		...
		btnClear.setIcon(new ImageIcon(Objects.requireNonNull(FinalProject_Manalili.class.getResource("/UsedPicture/icons8-clear-16.png"))));
		...
		btnSemantic.setIcon(new ImageIcon(Objects.requireNonNull(FinalProject_Manalili.class.getResource("/UsedPicture/icons8-right-arrow-16.png"))));
		btnSemantic.setEnabled(false);
		btnSemantic.setFocusPainted(false);
		btnSemantic.addActionListener(e -> SemanticAnalysis(valOfAll));
	...
	public void SyntaxAnalysis(String out) {
		// Syntax analysis
	...
	private void displayFileInfo(File file) {
		...
		lblValue.setText("<html><pre>  " + info2 + "</pre></html>");
